...
legend("Static Pressure", "Total Pressure",'Location','best',...
    "interpreter", "latex")
title("\textbf{Pressures (Subsonic)}",...
    "interpreter", "latex")
grid on
...
legend("Static Pressure", "Total Pressure",'Location','best',...
    "interpreter", "latex")
title("\textbf{Pressures (Supersonic)}",...
    "interpreter", "latex")
grid on
...
title({'\textbf{Experimental and Theoretical}',...
    '\textbf{Static Pressures (Subsonic)}'},...
    "interpreter", "latex")
xlabel("Tap Number",...
    "interpreter", "latex")
ylabel("Pressure (Pa)",...
...
title({'\textbf{Experimental and Theoretical}',...
    '\textbf{Mach Comparison (Subsonic)}'},...
    "interpreter", "latex")
xlabel("Tap Number",...
    "interpreter", "latex")
ylabel("Mach Number",...
...
title({'\textbf{Experimental and Theoretical}',...
    '\textbf{Static Pressures (Supersonic)}'},...
    "interpreter", "latex")
xlabel("Tap Number",...
    "interpreter", "latex")
ylabel("Pressure (Pa)",...
...
title({'\textbf{Experimental and Theoretical}',...
    '\textbf{Mach Comparison (Supersonic)}'},...
    "interpreter", "latex")
xlabel("Tap Number",...
    "interpreter", "latex")
ylabel("Mach Number",...
